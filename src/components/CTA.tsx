...
const testimonials = [
  { name: "Aïsha Diallo", role: "Influenceuse Mode", country: "🇸🇳 Dakar", avatar: "👩🏾", text: "Depuis que j'utilise AvyLink, mes ventes de mode ont triplé. Ma page est si belle que mes abonnés pensent que j'ai une agence derrière moi !", plan: "Premium" },
  { name: "Kwame Mensah", role: "Photographe Pro", country: "🇬🇭 Accra", avatar: "👨🏿", text: "AvyLink m'a permis de centraliser mon portfolio, mon Instagram et ma boutique. Je gagne 2x plus de clients depuis 3 mois.", plan: "Business" },
  { name: "Marie-Claire Koffi", role: "Coach Bien-être", country: "🇨🇮 Abidjan", avatar: "👩🏽", text: "Super facile à utiliser ! J'ai créé ma page en 10 minutes et mes clients trouvent tout mes services en un clic.", plan: "Starter" },
];
...
const cardAnim = {
  ...
  visible: { opacity: 1, y: 0, rotateX: 0, transition: { duration: 0.6, ease: [0.22, 1, 0.36, 1] as const } },
};
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="font-dm font-black text-4xl md:text-5xl text-foreground tracking-tight">
              Ils nous font <span className="bg-gradient-to-r from-primary to-[hsl(338,85%,65%)] bg-clip-text text-transparent">confiance</span>
            </h2>
          </motion.div>
          ...
          >
            {testimonials.map((t, idx) => (
              ...
              >
                {/* Giant quote mark */}
                <div className="absolute top-6 right-8 text-7xl font-serif text-primary/[0.04] leading-none select-none">"</div>
