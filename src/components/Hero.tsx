...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden gradient-hero pt-16">
      ...
      <div className="absolute bottom-20 left-10 w-56 h-56 bg-primary-light/20 rounded-full blur-2xl animate-float-delayed" />
      ...
      <div className="container mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Button
              size="lg"
              className="gradient-cta text-primary-foreground shadow-rose hover:shadow-rose-lg transition-all rounded-xl font-semibold text-base px-8 animate-pulse-rose"
            >
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative animate-float">
            <img
              ...
              className="w-full max-w-lg rounded-3xl shadow-rose-lg object-cover"
            />
            {/* Floating cards */}
